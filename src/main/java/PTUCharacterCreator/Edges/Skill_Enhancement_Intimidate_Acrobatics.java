...
public class Skill_Enhancement_Intimidate_Acrobatics extends Edge {
	{
		name = "Skill Enhancement Intimidate, Acrobatics";
	...
	public Skill_Enhancement_Intimidate_Acrobatics(){}
}