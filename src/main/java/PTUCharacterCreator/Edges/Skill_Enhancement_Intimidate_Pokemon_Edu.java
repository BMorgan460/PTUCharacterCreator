...
public class Skill_Enhancement_Intimidate_Pokemon_Edu extends Edge {
	{
		name = "Skill Enhancement Intimidate, Pokemon Edu";
	...
	public Skill_Enhancement_Intimidate_Pokemon_Edu(){}
}