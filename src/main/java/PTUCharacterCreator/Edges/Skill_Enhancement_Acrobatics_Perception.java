...
public class Skill_Enhancement_Acrobatics_Perception extends Edge {
	{
		name = "Skill Enhancement Acrobatics, Perception";
	...
	public Skill_Enhancement_Acrobatics_Perception(){}
}