...
public class Skill_Enhancement_Pokemon_Edu_Intuition extends Edge {
	{
		name = "Skill Enhancement Pokemon Edu, Intuition";
	...
	public Skill_Enhancement_Pokemon_Edu_Intuition(){}
}