...
public class Skill_Enhancement_Athletics_Pokemon_Edu extends Edge {
	{
		name = "Skill Enhancement Athletics, Pokemon Edu";
	...
	public Skill_Enhancement_Athletics_Pokemon_Edu(){}
}