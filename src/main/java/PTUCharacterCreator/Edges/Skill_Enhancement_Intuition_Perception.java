...
public class Skill_Enhancement_Intuition_Perception extends Edge {
	{
		name = "Skill Enhancement Intuition, Perception";
	...
	public Skill_Enhancement_Intuition_Perception(){}
	@Override
