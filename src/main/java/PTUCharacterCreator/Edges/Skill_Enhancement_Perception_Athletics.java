...
public class Skill_Enhancement_Perception_Athletics extends Edge {
	{
		name = "Skill Enhancement Perception, Athletics";
	...
	public Skill_Enhancement_Perception_Athletics(){}
}