...
public class Skill_Enhancement_Acrobatics_Pokemon_Edu extends Edge {
	{
		name = "Skill Enhancement Acrobatics, Pokemon Edu";
	...
	public Skill_Enhancement_Acrobatics_Pokemon_Edu(){}
}