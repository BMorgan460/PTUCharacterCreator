...
public class Skill_Enhancement_Pokemon_Edu_Intimidate extends Edge {
	{
		name = "Skill Enhancement Pokemon Edu, Intimidate";
	...
	public Skill_Enhancement_Pokemon_Edu_Intimidate(){}
}