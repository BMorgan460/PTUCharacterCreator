...
public class Skill_Enhancement_Acrobatics_Intimidate extends Edge {
	{
		name = "Skill Enhancement Acrobatics, Intimidate";
	...
	public Skill_Enhancement_Acrobatics_Intimidate(){}
}