...
public class Skill_Enhancement_Pokemon_Edu_Perception extends Edge {
	{
		name = "Skill Enhancement Pokemon Edu, Perception";
	...
	public Skill_Enhancement_Pokemon_Edu_Perception(){}
	@Override
