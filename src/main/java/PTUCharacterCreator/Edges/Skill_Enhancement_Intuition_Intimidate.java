...
public class Skill_Enhancement_Intuition_Intimidate extends Edge {
	{
		name = "Skill Enhancement Intuition, Intimidate";
	...
	public Skill_Enhancement_Intuition_Intimidate(){}
	@Override
