...
public class Skill_Enhancement_Athletics_Acrobatics extends Edge {
	{
		name = "Skill Enhancement Athletics, Acrobatics";
	...
	public Skill_Enhancement_Athletics_Acrobatics(){}
}