...
public class Skill_Enhancement_Intimidate_Athletics extends Edge {
	{
		name = "Skill Enhancement Intimidate, Athletics";
	...
	public Skill_Enhancement_Intimidate_Athletics(){}
	@Override
