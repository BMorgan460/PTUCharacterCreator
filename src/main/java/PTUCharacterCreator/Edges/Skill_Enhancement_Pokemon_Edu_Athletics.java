...
public class Skill_Enhancement_Pokemon_Edu_Athletics extends Edge {
	{
		name = "Skill Enhancement Pokemon Edu, Athletics";
	...
	public Skill_Enhancement_Pokemon_Edu_Athletics(){}
	@Override
