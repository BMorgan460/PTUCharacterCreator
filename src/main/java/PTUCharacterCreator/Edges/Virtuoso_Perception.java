...
public class Virtuoso_Perception extends Edge {
	{
		name = "Virtuoso Perception";
	...
	public Virtuoso_Perception(){}
	@Override
	public boolean checkPrereqs(Trainer t) {
		return t.aboveLevel(20) && t.checkSkillRank("Perception",6) && true;
	}
}