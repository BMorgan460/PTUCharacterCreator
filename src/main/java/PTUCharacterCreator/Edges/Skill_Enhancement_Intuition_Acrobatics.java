...
public class Skill_Enhancement_Intuition_Acrobatics extends Edge {
	{
		name = "Skill Enhancement Intuition, Acrobatics";
	...
	public Skill_Enhancement_Intuition_Acrobatics(){}
}