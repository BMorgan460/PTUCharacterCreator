...
public class Skill_Enhancement_Pokemon_Edu_Survival extends Edge {
	{
		name = "Skill Enhancement Pokemon Edu, Survival";
	...
	public Skill_Enhancement_Pokemon_Edu_Survival(){}
}