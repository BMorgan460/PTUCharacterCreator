...
public class Skill_Enhancement_Perception_Intuition extends Edge {
	{
		name = "Skill Enhancement Perception, Intuition";
	...
	public Skill_Enhancement_Perception_Intuition(){}
	@Override
