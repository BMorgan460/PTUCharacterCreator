...
public class Skill_Enhancement_Perception_Intimidate extends Edge {
	{
		name = "Skill Enhancement Perception, Intimidate";
	...
	public Skill_Enhancement_Perception_Intimidate(){}
	@Override
