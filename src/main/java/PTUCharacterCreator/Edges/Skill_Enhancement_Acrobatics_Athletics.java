...
public class Skill_Enhancement_Acrobatics_Athletics extends Edge {
	{
		name = "Skill Enhancement Acrobatics, Athletics";
	...
	public Skill_Enhancement_Acrobatics_Athletics(){}
}