...
public class Skill_Enhancement_Survival_Pokemon_Edu extends Edge {
	{
		name = "Skill Enhancement Survival, Pokemon Edu";
	...
	public Skill_Enhancement_Survival_Pokemon_Edu(){}
	@Override
