...
public class Skill_Enhancement_Pokemon_Edu_Acrobatics extends Edge {
	{
		name = "Skill Enhancement Pokemon Edu, Acrobatics";
	...
	public Skill_Enhancement_Pokemon_Edu_Acrobatics(){}
}