...
public class Skill_Enhancement_Intimidate_Intuition extends Edge {
	{
		name = "Skill Enhancement Intimidate, Intuition";
	...
	public Skill_Enhancement_Intimidate_Intuition(){}
}