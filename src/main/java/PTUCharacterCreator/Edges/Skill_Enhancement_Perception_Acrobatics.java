...
public class Skill_Enhancement_Perception_Acrobatics extends Edge {
	{
		name = "Skill Enhancement Perception, Acrobatics";
	...
	public Skill_Enhancement_Perception_Acrobatics(){}
}