...
public class Skill_Enhancement_Intimidate_Perception extends Edge {
	{
		name = "Skill Enhancement Intimidate, Perception";
	...
	public Skill_Enhancement_Intimidate_Perception(){}
	@Override
