...
public class Skill_Enhancement_Perception_Pokemon_Edu extends Edge {
	{
		name = "Skill Enhancement Perception, Pokemon Edu";
	...
	public Skill_Enhancement_Perception_Pokemon_Edu(){}
	@Override
