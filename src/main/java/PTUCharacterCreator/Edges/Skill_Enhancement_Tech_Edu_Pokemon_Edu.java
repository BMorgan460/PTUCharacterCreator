...
public class Skill_Enhancement_Tech_Edu_Pokemon_Edu extends Edge {
	{
		name = "Skill Enhancement Tech Edu, Pokemon Edu";
	...
	public Skill_Enhancement_Tech_Edu_Pokemon_Edu(){}
}