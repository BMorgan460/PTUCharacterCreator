...
public class Skill_Enhancement_Athletics_Intimidate extends Edge {
	{
		name = "Skill Enhancement Athletics, Intimidate";
	...
	public Skill_Enhancement_Athletics_Intimidate(){}
	@Override
