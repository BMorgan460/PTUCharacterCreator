...
public class Skill_Enhancement_Pokemon_Edu_Tech_Edu extends Edge {
	{
		name = "Skill Enhancement Pokemon Edu, Tech Edu";
	...
	public Skill_Enhancement_Pokemon_Edu_Tech_Edu(){}
}