...
public class Skill_Enhancement_Acrobatics_Intuition extends Edge {
	{
		name = "Skill Enhancement Acrobatics, Intuition";
	...
	public Skill_Enhancement_Acrobatics_Intuition(){}
}