...
public class Skill_Enhancement_Athletics_Perception extends Edge {
	{
		name = "Skill Enhancement Athletics, Perception";
	...
	public Skill_Enhancement_Athletics_Perception(){}
}