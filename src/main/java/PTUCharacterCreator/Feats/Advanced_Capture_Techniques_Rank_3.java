...
public class Advanced_Capture_Techniques_Rank_3 extends Feature {
	{
		name = "Advanced Capture Techniques Rank 3";
		tags = "[Ranked 4][+Speed]";
		frequency = "Static";
		...
		prereqs.put("any 2 Skills at Expert Rank", 0);
	}
	public Advanced_Capture_Techniques_Rank_3(){}
	@Override
	public boolean checkPrereqs(Trainer t) {
            String[] s = {"Acrobatics", "Athletics", "Stealth", "Survival", "Perception", "Guile"};
		return t.hasFeat("Capture Specialist") && checkMultipleSkills(t,s,5,2);
	}
}